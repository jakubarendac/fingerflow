...
# TODO : rozsirit dataset

DATASET_PATH = '/home/jakub/projects/dp/matcher_training_data/08032022004625/'
INPUT_SHAPE = (15, 6)
LOGS_FOLDER = 'logs-conv-contrast/scalars/' + datetime.now().strftime("%Y%m%d-%H%M%S")
EPOCHS = 500
BATCH_SIZE = 16
MARGIN = 1
MODEL_PATH = '/home/jakub/projects/dp/matcher_checkpoints/matcher_contrast_weights.h5'
...
input_1 = tf.keras.Input((15, 6, 1))
input_2 = tf.keras.Input((15, 6, 1))
...
history = siamese.fit(
    ...
    epochs=EPOCHS,
    callbacks=[tensorboard, checkpoint, learning_rate]
)
